        ...
        <section id='Statistics'>
           <div className={`container-1140px container-statistics ${sliderAnimation}`} ref={statisticsRef}>
            <div className='statistic-left'>
                ...
                <p>das pessoas pesquisam por negócios locais. Hoje é crucial para as empresas ter um site para serem encontradas.</p>
            </div>
            <div className='statistic-middle'>
                <h1>90%</h1>
                <h4>dos consumidores começam com uma pesquisa online.Estamos aqui para fazer justamente isso!</h4>
